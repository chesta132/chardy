      ...
      <div className="h-dvh w-screen p-4">
        <div ref={containerRef} className="relative h-full w-full rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex z-10 flex-col xl:justify-center p-8 xl:items-baseline items-center text-center xl:text-left mt-20 xl:mt-0">
            <p className="text-[clamp(0.7rem,1vw,0.875rem)] text-neutral-400 mb-4 font-supply-mono">( I AM CHESTA )</p>
            <h1 className="text-[clamp(2rem,5vw,3.75rem)]/[clamp(2.5rem,5.5vw,4.125rem)] text-white mb-4 uppercase font-neue-montreal">
              Lorem ipsum <br /> dolor
            </h1>
            <p className="text-[clamp(0.875rem,1.5vw,1.25rem)]/[clamp(1.1rem,2vw,1.1875rem)] text-neutral-200 max-w-lg font-neue-montreal">
          ...
          <div className="absolute inset-0 xl:flex flex-col hidden xl:justify-end p-8 text-[#d4d4d4]">
            <p className="flex items-center gap-2 font-neue-montreal">
